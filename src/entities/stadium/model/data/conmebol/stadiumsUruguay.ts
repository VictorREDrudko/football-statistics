...
export const stadiumsUruguay: StadiumsData = {
  centenario: new StadiumEntity(
    { city: 'Montevideo', country },
    [{ name: 'Estadio Centenario', period: '1930-p.t.' }],
    true,
    '60 235',
    '1930',
    ['1983', '2005', '2011', '2021'],
  ...
  parqueCentral: new StadiumEntity(
    { city: 'Montevideo', country },
    [{ name: 'Estadio Gran Parque Central', period: '1900-p.t.' }],
    true,
    '34 000',
    '1900',
  ...
  pocitos: new StadiumEntity(
    { city: 'Montevideo', country },
    [{ name: 'Estadio Pocitos', period: '1921-1933' }],
    false,
    '10 000',
    '1921',
    [],
