...
import { HistoryFootball } from './types'

const initialState: HistoryFootball = {
  historicalDates: [
...
export const historyFootballSlice = createSlice({
  name: 'history-football',
  initialState,
  reducers: {},
})

export default historyFootballSlice.reducer
